 ...
 * solvers.
 *
 * It implements the basic framework for the assignment code. Generally no need
 * to modify this, there are many abstract and non-abstract classes to customise
 * your implementation.
 */
public class RmitSudoku {
	...
	/**
	 * Inner class used to return a pair of values. Note on core teaching servers
	 * javafx.util.Pair isn't available.
	 */
